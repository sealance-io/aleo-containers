...
usage() {
    ...
    echo "  -v, --version <version>          Version tag for aleo-devnet image (default: v4.2.0-v4.7.3)"
    ...
    echo ""
    echo "Examples:"
    echo "  $0                               # Use defaults (main branch, v4.2.0-v4.7.3)"
    echo "  $0 -c develop -v v4.2.0-v4.7.3   # Use develop branch and v4.2.0-v4.7.3 image"
